  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${getServiceBySlug('workshops')?.image ?? ''})` }} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Continue your child's learning journey with these programs
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: 'School Readiness', href: '/school-readiness', description: 'School preparation programs for children ages 3-6.', color: 'bg-green-100 text-green-700' },
              { name: 'English Tutoring', href: '/english-tutoring', description: 'Ongoing English tutoring for continued progress.', color: 'bg-blue-100 text-blue-700' },
              { name: 'Maths Tutoring', href: '/maths-tutoring', description: 'Regular maths tutoring for lasting results.', color: 'bg-red-100 text-red-700' },
            ].map((service, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
