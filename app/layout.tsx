...
export const metadata: Metadata = {
  title: 'VCE Tutoring Melbourne | High School Tutoring Near Me | New Era Education',
  ...
  robots: 'index, follow',
  openGraph: {
    title: 'New Era Education - Premium Tutoring Services',
    ...
    images: [
      {
        url: 'https://neweraeducation.com.au/assets/hero-bg.jpg',
        width: 1200,
        height: 630,
        alt: 'New Era Education - Premium Tutoring Services',
      },
    ],
    locale: 'en_AU',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'New Era Education - Premium Tutoring Services',
    description: 'Qualified teachers with 10+ years experience. Evidence-based literacy & numeracy methods. Book your session today!',
    images: ['https://neweraeducation.com.au/assets/hero-bg.jpg'],
  },
  alternates: {
    canonical: 'https://neweraeducation.com.au',
  },
  other: {
    'geo.region': 'AU-VIC',
