...
export default function HomeschoolingContent() {
  return (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Additional support options for homeschooling families
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: 'English Tutoring', href: '/english-tutoring', description: 'Expert English curriculum support and literacy development.', color: 'bg-blue-100 text-blue-700' },
              { name: 'Maths Tutoring', href: '/maths-tutoring', description: 'Mathematics curriculum guidance and skill building.', color: 'bg-red-100 text-red-700' },
              { name: 'One-on-One Tutoring', href: '/one-on-one', description: 'Personalised one-on-one sessions tailored to your curriculum.', color: 'bg-orange-100 text-orange-700' },
            ].map((service, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
